...
public class HiorityDirectionActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    private String Distance, HtmlIns, Duration, StartLat, StartLon, EndLat, EndLon, IdNode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "HIORITY", Toast.LENGTH_SHORT).show();

        settingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HiorityDirectionActivity.this, ProfileActivity.class);
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(HiorityDirectionActivity.this, UserSearchActivity.class);
//                startActivity(intent);
//                overridePendingTransition(0, 0);
                executeCommand();
            }
...
//        new ParseJSonDataClass(this).execute();
    ...
    private void getLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            new ParseJSonDataClass(HiorityDirectionActivity.this).execute();
        } else {
    ...
    class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            HttpServiceClass httpServiceClass = new HttpServiceClass("http://common-id.com/hiority/parse2.php");
            ...
            try {
                ...
                if (httpServiceClass.getResponseCode() == 200) {
                    ...
                    Jobject = new JSONObject(FinalJSonResult);
                    String FinalArray = Jobject.getString("node_result");
                    String EdgeArray = Jobject.getString("edge_result");
                    JSONArray jsonArray = null;
                    JSONArray edgeArray = null;
                    try {
                        jsonArray = new JSONArray(FinalArray);
                        edgeArray = new JSONArray(EdgeArray);
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            classroom.setId(jsonObject.getString("node_id"));
                            classroom.setName(jsonObject.getString("node_name"));
                            classroom.setFloor("1");
                            classroom.setLatitude(jsonObject.getString("latitude"));
                            classroom.setLongitude(jsonObject.getString("longitude"));
...
//            Log.e("Respon ", FinalJSonResult);
            ...
            if (classroomList.size() == 0) {
                Toast.makeText(HiorityDirectionActivity.this, "Tidak ditemukan ruang kelas", Toast.LENGTH_SHORT).show();
            }
...
//        String sensor = "sensor=true&units=metric&mode=driving&key=AIzaSyBu6lTlBTHqaI8j87sDBQUxdCmE89Sn2Vc";
     ...
     * A class to parse the Google Directions in JSON format
     */
    private class GetAllTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ArrayList<LatLng> points = null;
            String html = null, distance, duration, start_lat, start_lon, end_lat, end_lon;
            // Traversing through all the routes
...
//                    public void run() {
                        ...
                        for (int j = 0; j < (path.size()-1); j++) {
                            for(int k=0; k<4; k++) {
                                ...
                                HtmlIns = point.get("html_instructions");
                                Distance = point.get("distance");
                                Duration = point.get("duration");
                                StartLat = point.get("start_lat");
                                StartLon = point.get("start_lon");
                                EndLat = point.get("end_lat");
                                IdNode = String.valueOf(b);
                                EndLon = point.get("end_lon");

                                Log.e("FinResult", String.valueOf(b + 1) + " Start:" + StartLat + ", " + StartLon + ", " +
                                        "End:" + EndLat + ", " + EndLon + " | Distance: " + Distance + " Duration: " + Duration +
                                        " Instructions:" + HtmlIns);

//                    if (j!=path.size()-1)
//                    new Handler().postDelayed(new Runnable() {
//                        public void run() {
                                new SaveDataClass(HiorityDirectionActivity.this).execute();
                                b++;
//                        }
//                    }, 2000);
                            }
...
//            Toast.makeText(getApplicationContext(), html, Toast.LENGTH_LONG).show();
    ...
    private class SaveDataClass extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            httpServiceClass = new HttpServiceClass("http://common-id.com/hiority/add.php");
            httpServiceClass.AddParam("html_instructions", HtmlIns);
            httpServiceClass.AddParam("distance", Distance);
            httpServiceClass.AddParam("duration", Duration);
            httpServiceClass.AddParam("start_lat", StartLat);
            httpServiceClass.AddParam("end_lat", EndLat);
            httpServiceClass.AddParam("start_lon", StartLon);
            httpServiceClass.AddParam("end_lon", EndLon);
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(HiorityDirectionActivity.this, IdNode + FinalResult, Toast.LENGTH_LONG).show();
        }
    }
            ...
            public void onInfoWindowClick(Marker googleMarker) {
                for (int position = 0; position < classroomList.size(); position++) {
                    ...
                    if (googleMarker.getTitle().equals(Name)) {
                        ...
                        Intent intent = new Intent(HiorityDirectionActivity.this, UserDetailActivity.class);
...
//            Toast.makeText(this, s, Toast.LENGTH_SHORT).show();
    ...
    public void onMapClick(LatLng point) {
        ...
        tujuan = new LatLng(point.latitude, point.longitude);
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(HiorityDirectionActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(HiorityDirectionActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
...
//                        toggleButtons();
    ...
    public void SelectLocation(View view) {
        executeCommand();
//        try {
//            ping(new URL("https://www.google.com/"), this);
