...
public class UserResultActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // location updates interval - 60sec
    ...
    private String Latitude, Longitude, SearchQuery, Name, Floor, IdClass, Address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UserResultActivity.this, ProfileActivity.class);
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(UserResultActivity.this, UserSearchActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
...
//        new ParseJSonDataClass(this).execute();
    ...
    private void getLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            new ParseJSonDataClass(UserResultActivity.this).execute();
        } else {
    ...
    class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
        ...
        String FinalJSonResult, ResultClass;
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            httpServiceClass.AddParam("search", SearchQuery);
                ...
                if (httpServiceClass.getResponseCode() == 200) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            ResultClass = jsonObject.getString("id");
        ...
        protected void onPostExecute(Void result) {
            ...
            if (ResultClass.isEmpty()||ResultClass.equals("null"))
                Toast.makeText(UserResultActivity.this, "Kelas tidak ditemukan", Toast.LENGTH_LONG).show();
            else {
                ...
                if (classroomList.size() == 0) {
                    Toast.makeText(UserResultActivity.this, "Tidak ditemukan ruang kelas", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onInfoWindowClick(Marker googleMarker) {
                for (int position = 0; position < classroomList.size(); position++) {
                    ...
                    if (googleMarker.getTitle().equals(Name)) {
                        ...
                        Intent intent = new Intent(UserResultActivity.this, UserDetailActivity.class);
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(UserResultActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(UserResultActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
